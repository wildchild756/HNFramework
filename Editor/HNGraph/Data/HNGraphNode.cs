...
{
    [Serializable]
    public class HNGraphNode : IDisposable, IPositionable, ISerializable
    {
        ...
        public HNGraphNode(HNGraphEditorData editorData, IHNGraphNode graphNodeClass, Vector2 position)
        {
